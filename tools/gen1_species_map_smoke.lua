...
assert(Gen1SpeciesMap.getDexId(0x78) == 87, "Dewgong internal id must map to Pokédex 87")
assert(Gen1SpeciesMap.getDexId(0x2B) == 106, "Hitmonlee internal id must map to Pokédex 106")
...
-- before Gen1SpeciesMap.initialize / DataAdapter.initializePokemonData rebuild
...
assert(Gen1SpeciesMap.getDexId(0x78) == 87, "Dewgong must still map after French names replace PokemonData")
assert(Gen1SpeciesMap.getDexId(0x2B) == 106, "Hitmonlee must still map after French names replace PokemonData")
assert(Gen1SpeciesMap.getDexId(0x99) == 1, "Bulbasaur must still map after French names replace PokemonData")
