...
assert(DataAdapter.expForLevel(0, 10) == 1000)
assert(DataAdapter.expForLevel(3, 10) == 560)
assert(DataAdapter.expForLevel(4, 10) == 800)
assert(DataAdapter.expForLevel(5, 10) == 1250)
