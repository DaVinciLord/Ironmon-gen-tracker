...
function Gen1RandomizerLog.prepareRoutes(logLines)
	local namedMaps = {
...
function Gen1RandomizerLog.finalizeRoutes()
...
function Gen1RandomizerLog.apply()
	-- RandomizerLog.lua now calls prepareRoutes/finalizeRoutes and uses RouteSetToMap.
end
