ScreenResources{
	...
	ExtrasScreen = {
		...
		ButtonEstimatePokemonIVs = "Estimer le potentiel DV",
	...
	LogOverlay = { -- Log Viewer
		...
		LabelYourDVs = "Tes DVs",
		LabelYourStatExp = "Tes Stat Exp",
		LabelShowIVs = "Show IVs", -- NEEDS TRANSLATION
		LabelShowEVs = "Show EVs", -- NEEDS TRANSLATION
		LabelShowDVs = "Voir DVs",
		LabelShowStatExp = "Voir EVs",
		LabelShowBST = "Show BST", -- NEEDS TRANSLATION
		ButtonLevelupMoves = "Niv.",
		ButtonTMMoves = "CT",
		LabelGymTMs = "CT Arènes",
